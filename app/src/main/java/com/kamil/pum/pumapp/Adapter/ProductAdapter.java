...
import static com.kamil.pum.pumapp.MainActivity.arrayList;
        ...
        viewHolder.productImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cartDecrement.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (cartCounter[0] == 1) {
                            Toast.makeText(context, "Nie można dodać ujemnej liczby", Toast.LENGTH_SHORT).show();
                        } else {
                            cartCounter[0] -= 1;
