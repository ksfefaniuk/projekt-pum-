package com.kamil.pum.pumapp.View;
import static com.kamil.pum.pumapp.Adapter.ProductAdapter.cartModels;
import com.kamil.pum.pumapp.Adapter.CartAdapter;
import com.kamil.pum.pumapp.MainActivity;
...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        grandTotal.setText("cena:"+ String.valueOf(grandTotalplus)+"zł" );    //wysw cene
        ...
        proceedToBook.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(CartActivity.this, "Zamówienie złożone", Toast.LENGTH_SHORT).show();
            }
        });
    }
